...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-900 grid grid-cols-1 lg:grid-cols-12 font-sans antialiased text-slate-800">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl lg:text-4xl font-extrabold text-white tracking-tight leading-tight">
              Clinical Workspace Authentication
            </h1>

            <p className="text-slate-400 text-sm leading-relaxed max-w-md font-medium">
              Sign in to manage patient consultations, search medical records,
              and access real-time healthcare analytics.
            </p>
          </div>
          ...
          <div className="mt-10 space-y-3.5 pt-8 border-t border-slate-800/80">
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              ...
              <span>Patient Consultation & Prescription Suite</span>
            </div>
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              <CheckCircle2 size={16} className="text-emerald-400 shrink-0" />
              <span>Encrypted Administrative Portal</span>
            </div>
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              <CheckCircle2 size={16} className="text-emerald-400 shrink-0" />
              <span>Real-time OPD Patient Queue Syncing</span>
            </div>
          </div>
        </div>
      ...
      {/* Right Side: Clean White Login Form Container */}
        ...
        <div className="max-w-md mx-auto w-full space-y-6">
          <div>
            ...
            <p className="text-slate-500 text-xs sm:text-sm mt-1 font-medium">
              Enter your clinical credentials to continue to the dashboard.
            </p>
          </div>
